...
class Job:
    ...
    def __init__(self, username: str, password: str, expected_ip: str):
        self._username: str = username
        self._password: str = password
        self._expected_ip: str = expected_ip
        self._token: str = ""
        self._info: dict = {}
        self._tag: str = ""
    ...
    @property
    def _update_info_header(self) -> dict or None:
        return {"X-Forwarded-For": self._expected_ip} if self._expected_ip != "" else None
